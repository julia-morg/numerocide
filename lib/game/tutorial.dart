  ...
  List<Stage> getSteps() {
    List<Stage> stages = [
      Stage(
          ...
          [1, 9, 4, 5, 3, 8],
          Hint(0, 1)),
      Stage('… or are located one above the other', 6, [3, 9, 2, 5, 8, 4, 7, 5],
          Hint(0, 6)),
      Stage(
          ...
          [3, 2, 1, 5, 8, 4, 6, 5],
          Hint(5, 6)),
      Stage('If the cells are diagonal to each other, you can also remove them',
          6, [4, 9, 3, 5, 7, 2, 1, 5, 4, 2], Hint(1, 6)),
      Stage('The direction of the diagonal doesn’t matter', 6,
          [2, 4, 1, 5, 7, 9, 5, 8, 3, 8], Hint(0, 7)),
      Stage(
      ...
      Stage('If you clear the entire board, you advance to the next level', 6,
          [3, 5, 5, 7, 4, 9, 6, 7, 4, 2, 4, 1, 8, 7], Hint(-10, -14)),
    ];
    return stages;
  }
}
